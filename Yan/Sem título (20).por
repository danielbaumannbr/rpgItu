...
inclua biblioteca Util --> u
  funcao inicio() {
    ...
    //Introdução parte 2
    escreva("----------------------------------------------------------------------------------------------------------------------------------------------------------------")
    escreva("\nApós desembarcarem em Carpa Grande, vocês caminham pelas ruas com passos silenciosos e observando tudo. A cidade parece tranquila demais, mas há algo estranho no ar — como se o tempo ali passasse mais devagar, como se os olhares durassem tempo demais.Voces foram para o CARPA TRANSPORTES e queriam alugar um carro, cristofer toma a frente e diz:-o moçinha.")
